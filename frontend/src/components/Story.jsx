...
const Story = () => {
  ...
  return (
    <div className="bg-white p-4 mb-6 rounded-xl shadow-md">
      ...
      <h2 className="text-xl font-bold text-blue-700 mb-4">Stories</h2>
      ...
      <div className="flex space-x-3 overflow-x-auto pb-2 scrollbar-thin scrollbar-thumb-gray-300">
        {userStories.length === 0 && (
          ...
          >
            ...
            <span className="text-sm mt-2 font-medium">Add Story</span>
          </div>
        )}
          ...
          >
            ...
            {story.uname === username && (
              <>
                ...
                {showDropdown && (
                  <div
                    className="absolute top-6 right-1 bg-white shadow-lg border rounded px-2 py-1 z-20"
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-md relative">
            ...
            <h3 className="text-xl font-semibold mb-4 text-blue-700">Create a Story</h3>
